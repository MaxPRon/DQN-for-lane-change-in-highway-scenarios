...
for x in range(0,14401,400):
    num_of_episodes = x

    final_save_path = "./long/model_long_random_2/modelRL_0_"+str(num_of_episodes)+ ".ckpt"
    ...
    image_save_path = './long/model_long_random_2/Process/'
    ...
    ax1.grid()
    plt.savefig(image_save_path+"trajectory/" + str(num_of_episodes) + "_trajectory.png")
    ...
    plt.tight_layout()
    plt.savefig(image_save_path+"behavior/" + str(num_of_episodes) + "_behaviour.png")
    plt.show(block=False)
    #plt.show(block=False)
    plt.clf()
    ...
    plt.savefig(image_save_path+"reward/" + str(num_of_episodes) + "_reward.png")
    plt.show(block=False)
    #plt.show()
    plt.clf()
    ...
    plt.savefig(image_save_path+"q_value/" + str(num_of_episodes) + "_Q_values.png")
    #plt.show(block=False)
    plt.show(block=False)
    plt.clf()
